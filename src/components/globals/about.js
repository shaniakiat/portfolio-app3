  ...
  <section className="about" id="about">
    <Fade left>
      ...
      <p>
        ...
        <br />
        <br />
        I’m passionate about delivering high-performance and intuitive design of
        web applications to the users while positively impacting the world
        through my work and interactions with others.
        <br />
        <br />
        During my time at La Salle, I was the Vice President of La Salle ACM. I
        was also involved in La Salle Math Club and Programming Team. In Spring
